...
class DownloadCriteriaReportWithSelector {
  ...
  public static function runExample(AdWordsSession $session, $filePath) {
    ...
    $selector->setFields(['CampaignId','CampaignName', 'Impressions', 'Clicks', 'Cost','Date']);

    // Use a predicate to filter out paused criteria (this is optional).
     $selector->setPredicates([
         new Predicate('CampaignId', PredicateOperator::EQUALS, [924255066])]);
  ...
  public static function main() {
    ...
    $session = (new AdWordsSessionBuilder())
		...
		->withClientCustomerId(5888330090)
        ->build();
